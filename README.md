...
**Image Path**: `public.ecr.aws/your-alias/git`
...
```bash
docker pull public.ecr.aws/your-alias/git:git
```
```bash
docker pull public.ecr.aws/your-alias/git:container
```
```bash
docker pull public.ecr.aws/your-alias/git:enterprise
```
...
```bash
docker run -it --name git public.ecr.aws/your-alias/git:latest
```
...
docker run -d --name git-prod \
  ...
  public.ecr.aws/your-alias/git:latest
```

Volume Mount Mount local directory for persistent data

```bash
docker run -v /app:/app public.ecr.aws/your-alias/git:latest
```

Port Forwarding Run with custom port mappings

```bash
docker run -p 8080:8080 public.ecr.aws/your-alias/git:latest
```
