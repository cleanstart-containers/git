## Container Documentation for Git Documentation
...
**Image Path**: `ghcr.io/cleanstart-containers/git`
...
```bash
docker pull ghcr.io/cleanstart-containers/git:latest
```
```bash
docker pull ghcr.io/cleanstart-containers/git:latest-dev
```
...
```bash
docker run -it --name git ghcr.io/cleanstart-containers/git:latest --version
```
...
docker run -d --name git-prod \
  ...
  ghcr.io/cleanstart-containers/git:latest --version
```

Volume Mount Mount local directory for persistent data

```bash
docker run -v /app:/app ghcr.io/cleanstart-containers/git:latest --version
```

Port Forwarding Run with custom port mappings

```bash
docker run -p 8080:8080 ghcr.io/cleanstart-containers/git:latest --version
```
